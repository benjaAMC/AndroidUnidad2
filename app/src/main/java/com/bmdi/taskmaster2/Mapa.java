...
public class Mapa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Coordenadas de la moneda
        double Latitud1 = -33.4424144; // Latitud de la moneda
        double Longitud1 = -70.6565204; // Longitud de la moneda

        // Crear objetos GeoPoint para las coordenadas definidas.
        GeoPoint Moneda = new GeoPoint(Latitud1, Longitud1);
        // Configura la vista inicial del mapa centrada  con un nivel de zoom de 15.
        mapView.getController().setZoom(15.0);
        // Centra el mapa en el punto de Santiago.
        mapView.getController().setCenter(Moneda);

        // Marcador
        Marker marcadorMoneda = new Marker(mapView);
        // Establece la posición del marcador en el punto de IP Santo Tomás.
        marcadorMoneda.setPosition(Moneda);
        // Establece el ancla del marcador.
        marcadorMoneda.setAnchor(Marker.ANCHOR_CENTER, Marker.ANCHOR_BOTTOM);
        // Establece el título del marcador.
        marcadorMoneda.setTitle("La moneda");
        // Establece una descripción para el marcador.
        marcadorMoneda.setSnippet("Oficinas centrales de TaskMaster");

        // Agregar los marcadores al mapa.
        mapView.getOverlays().add(marcadorMoneda);



        // Coordenadas
        double Latitud2 = -17.8813269; // Latitud .
        double Longitud2 = -63.2819574; // Longitud .

        // Crear objetos GeoPoint para las coordenadas definidas.
        GeoPoint parquePoint = new GeoPoint(Latitud2, Longitud2);
        ...
        // Establece el título del marcador.
        marcadorParque.setTitle("Oficina en bolivia de taskmaster");
        // Establece una descripción para el marcador.
